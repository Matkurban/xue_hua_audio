...
Cross-platform Flutter FFI audio plugin powered by Rust/rodio.
  ...
  s.pod_target_xcconfig = {
    ...
    'OTHER_LDFLAGS' => '-framework AudioToolbox -framework CoreAudio -framework AVFoundation -framework CoreFoundation -force_load ${PODS_CONFIGURATION_BUILD_DIR}/xue_hua_audio/libxue_hua_audio.a',
  }
end
